...
def upgrade() -> None:
    ...
    op.add_column(
        "user", sa.Column("registration_token_expires", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "user", sa.Column("password_renewal_token", sa.String(), nullable=True)
    )
    op.add_column(
        "user",
        sa.Column("password_renewal_token_expires", sa.DateTime(), nullable=True),
    )
