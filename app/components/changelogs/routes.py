...
@router.get(
    "/search/", response_model=List[changelogs.schemas.OrganizationChangelogOut]
)
...
@router.put(
    "/visibility/{changelog_id}", response_model=changelogs.schemas.ChangelogOut
)
async def toggle_visibility(
    ...
    if (
        ...
        and changelog.user.organization != current_user.organization
    ):
